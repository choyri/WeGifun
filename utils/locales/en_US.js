const string = {
  ...
  common_about: {
    ...
    reward: 'Reward',
    reward_content: 'Would you like to give me a cup of coffee? :)',
    reward_ok: 'Fine!',
  ...
  common_setting: {
    ...
    schedule_hide_course: 'Hide not-this week courses',
  ...
  service_edu_schedule_custom: {
    ...
    'form_field': ['Time', 'Week', 'Name', 'Classroom', 'Teacher', 'Duration'],
    ...
    'form_duration_list': ['1 section', '2 sections', '3 sections', '4 sections', '5 sections', '6 sections'],
